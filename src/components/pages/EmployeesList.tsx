          ...
          <table className="w-full text-right">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-100">
                ...
                <th className="px-8 py-5 text-sm font-black text-gray-400 uppercase tracking-wider">القسم الإداري</th>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-6 max-h-[70vh] overflow-y-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-500 mr-2">البريد الإلكتروني (لتسجيل الدخول)</label>
                    <input 
                      type="email"
                      className="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none font-medium text-left"
                      dir="ltr"
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-500 mr-2">الرقم القومي</label>
                    <input 
                      className="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none font-medium"
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={(e) => setFormData({...formData, housingAllowance: Number(e.target.value) || 0})}
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={(e) => setFormData({...formData, subsistenceAllowance: Number(e.target.value) || 0})}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={(e) => setFormData({...formData, mobileAllowance: Number(e.target.value) || 0})}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={(e) => setFormData({...formData, managementAllowance: Number(e.target.value) || 0})}
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={(e) => setFormData({...formData, otherAllowances: Number(e.target.value) || 0})}
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-500 mr-2">جدول الدوام</label>
                    <select 
                      className="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none font-medium"
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-500 mr-2">مدير الموظف (المسؤول المباشر)</label>
                    <select 
                      className="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none font-medium"
                      value={formData.managerId}
                      onChange={(e) => setFormData({...formData, managerId: e.target.value})}
                    >
                      <option value="">لا يوجد مدير (مدير أعلى)</option>

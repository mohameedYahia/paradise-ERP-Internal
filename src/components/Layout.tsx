...
export const Layout: React.FC = () => {
  ...
  const menuItems = [
    ...
    { id: 'my-tasks', label: 'مهامي الشخصية', icon: CheckCircle2, show: true },
    { id: 'operations', label: 'إدارة العمليات', icon: Briefcase, show: true },
    { id: 'admin-structure', label: 'الهيكل الإداري', icon: Network, show: true },
    { id: 'employees', label: 'الموظفين', icon: Users, show: isHR },
    { id: 'org-chart', label: 'الهيكل التنظيمي', icon: Link, show: isHR || isAdmin || isFinance },
    { id: 'attendance', label: 'الحضور والانصراف', icon: Fingerprint, show: isHR },
    { id: 'missions', label: 'المأموريات', icon: FileText, show: isHR },
    ...
    { id: 'settlements', label: 'تصفية البيانات', icon: ShieldCheck, show: isHR || isFinance },
